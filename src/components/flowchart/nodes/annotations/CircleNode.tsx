/**
 * Circle Annotation Node
 * A resizable circle shape (maintains aspect ratio) for highlighting elements
 */
  ...
  return (
    <>
      <NodeResizer
        ...
        handleClassName="!w-3 !h-3 !bg-white !border-2 !border-blue-400 !rounded-full"
